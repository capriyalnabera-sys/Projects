...
const GLOBAL_INVESTORS = [
  ...
  // --- Singapore-focused VCs ---
  { name: 'Insignia Ventures Partners', institution: 'Insignia Ventures Partners', avg_cheque_size: '$1M - $10M', geographies: 'Singapore, Southeast Asia, India', sectors: 'fintech, e-commerce, logistics, saas, consumer', stage: 'Seed, Series A', website: 'https://www.insignia.vc', source: 'curated' },
  { name: 'Quest Ventures', institution: 'Quest Ventures', avg_cheque_size: '$500K - $5M', geographies: 'Singapore, Southeast Asia', sectors: 'e-commerce, fintech, logistics, deeptech', stage: 'Seed, Series A', website: 'https://www.questventures.com', source: 'curated' },
  { name: 'Vickers Venture Partners', institution: 'Vickers Venture Partners', avg_cheque_size: '$2M - $20M', geographies: 'Singapore, Southeast Asia, India', sectors: 'deeptech, biotech, cleantech, ai', stage: 'Series A, Series B', website: 'https://www.vickersventure.com', source: 'curated' },
  { name: 'Monk\'s Hill Ventures', institution: 'Monk\'s Hill Ventures', avg_cheque_size: '$1M - $10M', geographies: 'Singapore, Southeast Asia', sectors: 'saas, fintech, deeptech, enterprise', stage: 'Seed, Series A', website: 'https://www.monkshill.com', source: 'curated' },
  { name: 'Cocoon Capital', institution: 'Cocoon Capital', avg_cheque_size: '$200K - $2M', geographies: 'Singapore, Southeast Asia', sectors: 'saas, ai, deeptech, enterprise', stage: 'Pre-Seed, Seed', website: 'https://www.cocooncapital.com', source: 'curated' },
  { name: 'TNB Aura', institution: 'TNB Aura', avg_cheque_size: '$500K - $5M', geographies: 'Singapore, Southeast Asia', sectors: 'fintech, e-commerce, saas, consumer', stage: 'Seed, Series A', source: 'curated' },
  { name: 'Vertex Ventures SEA & India', institution: 'Vertex Ventures SEA & India', avg_cheque_size: '$2M - $20M', geographies: 'Singapore, India, Southeast Asia', sectors: 'fintech, healthtech, enterprise, consumer', stage: 'Seed, Series A, Series B', website: 'https://www.vertexventures.com', source: 'curated' },
  { name: 'Pavilion Capital', institution: 'Pavilion Capital', avg_cheque_size: '$10M - $50M', geographies: 'Singapore, Southeast Asia, India', sectors: 'fintech, healthcare, consumer, logistics', stage: 'Series B, Growth', source: 'curated', notes: 'Temasek subsidiary' },
  { name: 'EDBI', institution: 'EDBI', avg_cheque_size: '$10M - $50M', geographies: 'Singapore', sectors: 'biotech, deeptech, ai, cleantech, medtech', stage: 'Series A, Series B, Growth', website: 'https://www.edbi.com', source: 'curated', notes: 'Singapore EDB investment arm' },
  { name: 'SGInnovate', institution: 'SGInnovate', avg_cheque_size: '$250K - $2M', geographies: 'Singapore', sectors: 'deeptech, ai, blockchain, biotech, quantum', stage: 'Pre-Seed, Seed', website: 'https://www.sginnovate.com', source: 'curated', notes: 'Singapore government-backed' },
  { name: 'Wavemaker Partners', institution: 'Wavemaker Partners', avg_cheque_size: '$500K - $5M', geographies: 'Singapore, Southeast Asia, India', sectors: 'deeptech, saas, healthtech, sustainability', stage: 'Seed, Series A', website: 'https://wavemaker.vc', source: 'curated' },
  { name: 'iGlobe Partners', institution: 'iGlobe Partners', avg_cheque_size: '$1M - $10M', geographies: 'Singapore, Southeast Asia', sectors: 'deeptech, ai, saas, cybersecurity', stage: 'Seed, Series A', source: 'curated' },
  { name: 'Antler', institution: 'Antler', avg_cheque_size: '$100K - $1M', geographies: 'Singapore, India, Southeast Asia, Global', sectors: 'saas, fintech, deeptech, ai, consumer', stage: 'Pre-Seed, Seed', website: 'https://www.antler.co', source: 'curated' },
  { name: 'Iterative', institution: 'Iterative', avg_cheque_size: '$150K - $500K', geographies: 'Singapore, Southeast Asia', sectors: 'saas, fintech, ai, consumer', stage: 'Pre-Seed, Seed', website: 'https://iterative.vc', source: 'curated' },
  { name: 'Beenext', institution: 'Beenext', avg_cheque_size: '$500K - $5M', geographies: 'India, Singapore, Southeast Asia', sectors: 'fintech, saas, consumer, e-commerce', stage: 'Seed, Series A', website: 'https://www.beenext.com', source: 'curated', notes: 'Founded by Teruhide Sato' },
  { name: 'Altara Ventures', institution: 'Altara Ventures', avg_cheque_size: '$2M - $15M', geographies: 'Singapore, Southeast Asia, India', sectors: 'saas, fintech, enterprise, ai', stage: 'Series A, Series B', source: 'curated' },
  { name: 'Global Founders Capital', institution: 'Global Founders Capital', avg_cheque_size: '$1M - $10M', geographies: 'Singapore, Southeast Asia, Global', sectors: 'fintech, saas, e-commerce, consumer', stage: 'Seed, Series A', source: 'curated' },
  { name: 'Rakuten Ventures', institution: 'Rakuten Ventures', avg_cheque_size: '$2M - $20M', geographies: 'Singapore, India, Southeast Asia', sectors: 'fintech, e-commerce, logistics, consumer', stage: 'Series A, Series B', source: 'curated' },
];
